...
try:
    cnn = tf.keras.models.load_model('C:/Users/jerwin/Documents/GitHub/butterfly_photos/model/Butterfly_CNN_Model.h5') #Change to your model's filename
...
class_labels = {
    ...
    14:'Butterfly - Scarlet Mormon',
    15: 'Butterfly-Tailed Jay',
    16: 'Moth-Atlas',
    17: 'Moth-Giant Silk',
    18: 'None try again!!'
}
...
def predict_image(cnn):
    try:
        img = load_img(cnn, target_size=(64, 64))
